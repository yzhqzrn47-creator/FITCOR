...
const advantages = [
  ...
  { icon: '💬', title: 'זמינות אישית 24/6 בוואטסאפ', description: 'אני כאן איתך ביום-יום. לכל שאלה, התייעצות, דיוק טכניקה או זריקת מוטיבציה.' },
  ...
  return (
    <main dir="rtl" style={{ backgroundColor: '#070708', color: '#fff', fontFamily: 'system-ui, sans-serif', overflowX: 'hidden' }}>
      ...
      <section style={{ padding: '160px 24px 60px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#a1a1aa', fontSize: '16px', maxWidth: '520px', margin: '0 auto' }}>תוכנית אימונים ותזונה מותאמת אישית, ליווי מקצועי צמוד אונליין — 24/6.</p>
      </section>
