        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#a1a1aa', fontSize: '16px', lineHeight: '1.8', margin: 0 }}>
              אני מאמין בליווי אישי, בגובה העיניים, תוך התאמה מדויקת של התוכניות אל סדר היום שלך. הליווי שלי משלב מדע, התמדה ומשמעת עצמית שיבטיחו שתגיע לגירסה הטובה ביותר של עצמך.
            </p>
          </div>
